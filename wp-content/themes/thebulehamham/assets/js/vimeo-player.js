/*! For license information please see vimeo-player.js.LICENSE.txt */ ! function(e) {
    var t = {};
    ...
    "8oxB": function(e, t) {
        ...
        function d() {
            s && c && (s = !1, c.length ? l = c.concat(l) : f = -1, l.length && h())
        }
        ...
        o.nextTick = function(e) {
            ...
            l.push(new m(e, t)), 1 !== l.length || s || a(h)
            ...
            ! function(e, n) {
                ...
                if (!e.setImmediate) {
                    ...
                    d = d && d.setTimeout ? d : e, "[object process]" === {}.toString.call(e.process) ? r = function(e) {
                        ...
                        t.source === e && "string" == typeof t.data && 0 === t.data.indexOf(u) && m(+t.data.slice(u.length))
    ...
    hMnm: function(e, t, n) {
        ...
        (function(e, n) {
            ...
            if (!(i || f && d)) throw new Error("Sorry, the Vimeo Player API is not available in this browser.");
            var h = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0 !== e ? e : "undefined" != typeof self ? self : {};
            ! function(e) {
                if (!e.WeakMap) {
            ...
            var m = function(e, t) {
                    ...
                    var t, r, o;
                    o = function() {
                        var e, t, r, o = Object.prototype.toString,
                        ...
                        function s(e) {
                            ...
                            if (!n.triggered) {
                                ...
                                try {
                                    ...
                                    })): (n.msg = e, n.state = 1, n.chain.length > 0 && u(c, n))
                                } catch (e) {
                                    f.call(new h(n), e)
                                }
                            }
                        ...
                        function f(e) {
                            var t = this;
                            t.triggered || (t.triggered = !0, t.def && (t = t.def), t.msg = e, t.state = 2, t.chain.length > 0 && u(c, t))
                        }
                        ...
                        function v(e) {
                            ...
                            this.then = function(e, n) {
                                ...
                                })), t.chain.push(r), 0 !== t.state && u(c, t), r.promise
                        ...
                        var p = e({}, "constructor", v, !1);
                        return v.prototype = p, e(p, "__NPO__", 0, !1), e(v, "resolve", (function(e) {
                    ...
                    }, (r = h)[t = "Promise"] = r[t] || o(), e.exports && (e.exports = r[t])
                })),
                v = new WeakMap;
            ...
            function g(e, t, n) {
                ...
                var o = r[t].indexOf(n);
                return -1 !== o && r[t].splice(o, 1), v.set(e.element, r), r[t] && 0 === r[t].length
            }
            ...
            var b = ["autopause", "autoplay", "background", "byline", "color", "controls", "dnt", "height", "id", "loop", "maxheight", "maxwidth", "muted", "playsinline", "portrait", "responsive", "speed", "texttrack", "title", "transparent", "url", "width"];
                    ...
                    a.open("GET", i, !0), a.onload = function() {
                        if (404 !== a.status)
                            if (403 !== a.status) try {
                                ...
                                if (403 === t.domain_status_code) return T(t, n), void o(new Error("“".concat(e, "” is not embeddable.")));
                                r(t)
                            } catch (e) {
                                o(e)
            ...
            function M(e, t) {
                var n, r = [];
                if ((t = _(t)).event) {
                    if ("error" === t.event) y(e, t.data.method).forEach((function(n) {
                            ...
                            if (n._onMessage = function(t) {
                                    if (l(t.origin) && n.element.contentWindow === t.source) {
                                        ...
                                        var u = o && "ready" === o.event,
                                            a = o && "ping" === o.method;
                                        if (u || a) return n.element.setAttribute("data-ready", "true"), void e();
                                        M(n, o)
                                    }
                                }, n._window.addEventListener("message", n._onMessage), "IFRAME" !== n.element.nodeName) {
                                var i = k(t, o);
                                E(s(i), i, t).then((function(e) {
                                    var r = T(e, t);
                                    return n.element = r, n._originalElement = t, w(t, r), x.set(n.element, n), e
                                })).catch(r)
                            }
                        }));
                        if (j.set(this, u), x.set(this.element, this), "IFRAME" === this.element.nodeName && P(this, "ping"), F.isEnabled) {
                            var c = function() {
                                return F.exit()
                            };
                            F.on("fullscreenchange", (function() {
                                F.isFullscreen ? p(n, "event:exitFullscreen", c) : g(n, "event:exitFullscreen", c), n.ready().then((function() {
                                    P(n, "fullscreenchange", F.isFullscreen)
                                }))
                            }))
                        }
                        return this
                    ...
                    return t = e, (n = [{
                        ...
                        value: function(e) {
                            ...
                            return new m((function(n, r) {
                                return e = u(e, "get"), t.ready().then((function() {
                                    p(t, e, {
                                        resolve: n,
                                        reject: r
                                    }), P(t, e)
                        ...
                        value: function(e, t) {
                            var n = this;
                            return new m((function(r, o) {
                                if (e = u(e, "set"), null == t) throw new TypeError("There must be a value to set.");
                        ...
                        key: "getFullscreen",
                        value: function() {
                            return F.isEnabled ? m.resolve(F.isFullscreen) : this.get("fullscreen")
                        }
                    }, {
                        ...
                        value: function() {
                            ...
                            return new m((function(t) {
                                if (j.delete(e), x.delete(e.element), e._originalElement && (x.delete(e._originalElement), e._originalElement.removeAttribute("data-vimeo-initialized")), e.element && "IFRAME" === e.element.nodeName && e.element.parentNode && e.element.parentNode.removeChild(e.element), e.element && "DIV" === e.element.nodeName && e.element.parentNode) {
                    ...
                    n = {
                        request: function(t) {
                            return new Promise((function(r, o) {
                                ...
                                var u = (t = t || document.documentElement)[e.requestFullscreen]();
